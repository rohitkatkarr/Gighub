  ...
  return (
    <div>
      <div>
        ...
        A weekly newsletter by Gighub designed to tell you everything you need to download, watch, read, listen to, and explore that fits in The Employment universe.
        </p>
